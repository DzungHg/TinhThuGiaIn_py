...
class MayCanGap:
    def __init__(self, bHR, thoiGianSanSang, daySoLuongCB, dayLoiNhuanCB, tocDo):
        self.BHR = bHR
        self.TocDo = tocDo
...
#-----
class GiaMayCanGap:
    def __init__(self, mayCanGap, soCon, tyLeSales):
        self.SoCon = soCon
    ...
    def chiPhi(self ):
        ...
        phiSetup = self.MayCanGap.ThoiGianSanSang * self.MayCanGap.BHR #Lấy giờ
